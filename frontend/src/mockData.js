...
export const album_data = [
  { album_id: 1, artist: "#Hashtag", label: "Vegan Tequila", release_year: "2020", title: "Jager Bomb Blues" },
  { album_id: 2, artist: "Better Than Mega Charged", label: "Power Records", release_year: "1997", title: "Still Better Than Mega Charged" },
  { album_id: 3, artist: "Better Than Mega Charged", label: "Power Records", release_year: "1999", title: "Now Even Better Than Mega Charged" },
  { album_id: 4, artist: "Mega Charged", label: "District Records", release_year: "1997", title: "Screaming into the Abyss" },
  { album_id: 5, artist: "Mega Charged", label: "District Records", release_year: "2017", title: "20 Years of Screaming" },
  { album_id: 6, artist: "#Hashtag", label: "Shasta", release_year: "2021", title: "Now That's What I Call Covid!" },
  { album_id: 7, artist: "#Hashtag", label: "During June", release_year: "2024", title: "After July" },
  { album_id: 8, artist: "#Hashtag", label: "During June", release_year: "2022", title: "Cold Beer" },
];

export const album_columns = ["Album ID", "Artist", "Label", "Release Year", "Title"];

export const song_students_data = [
  { song_id: 1, student_id: 1, song_title: 'Hot August Rain', student_name: 'Juno Wilder', is_learned: false },
  { song_id: 2, student_id: 1, song_title: 'Corona Rumba', student_name: 'Juno Wilder', is_learned: false },
  { song_id: 3, student_id: 1, song_title: 'Metal Mouth', student_name: 'Juno Wilder', is_learned: false },
